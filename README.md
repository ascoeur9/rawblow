...
- **그리드 다중 선택** — Ctrl(⌘)+클릭 토글, 클릭 후 Shift+클릭 범위 선택 → Q/W/E/R로 **한꺼번에** 분류
...
- **전송(Transfer)** — 고른 파일만 복사/이동(라벨별 폴더, 동반 파일, 충돌 시 일련번호)
- **비파괴 저장** — 폴더 안 `.rawblow/session.json`(+사람이 읽는 txt)에 분류 저장·복원
